...
public class FLengthShopRenewTest extends BaseClass1 {
	static int i = 2;

	@Test
	public void shopRenewFLengthTest() throws EncryptedDocumentException, Throwable {
		...
		WebDriverUtils1.dropdown(rent, 1);
		...
		WebDriverUtils1.dropdown(pid, 5);
		...
		WebDriverUtils1.dropdown(supportid, 2);
