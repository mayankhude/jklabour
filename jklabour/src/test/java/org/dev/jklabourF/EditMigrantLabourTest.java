...
import org.dev.jklabour.ObjectRepositoryA.EstablishmentsEmployingMigrantLabourMenu;
...
public class EditMigrantLabourTest extends BaseClass1 {

	static int i = 10;

	@Test

	public void Test1MigrantRegistration() throws EncryptedDocumentException, Throwable {
  ...
  {
	  EstablishmentsEmployingMigrantLabourMenu al=PageFactory.initElements(driver, EstablishmentsEmployingMigrantLabourMenu.class);
		al.establishmentsLabour();
