...
public class FactroryRenewFLengthTest extends BaseClass1{
	...
	public void facoryLengthTest() throws EncryptedDocumentException, Throwable
		...
		/*--------------------------Form start -----------------------------------*/
				  ...
				  driver.findElement(By.xpath("//input[@name='factory_name']"))
				    ...
				    driver.findElement(By.xpath("//input[@name='communication_address_2']"))
				     .sendKeys(name);  
	        ...
	        WebElement nic5 =driver.findElement(By.id("nic-5"));
			 ...
			 /*------------------------13. Full name and address of the owner ----------------------*/      
				     ...
				     driver.findElement(By.xpath("//input[@name='owner_address_2']"))
				      .sendKeys(name); 
			 ...
			 /*----------------------16 (1). Factory Registration Period*---------------*/
				    ...
				    WebElement we=  driver.findElement(By.xpath("//select[@name='consent_certificate_id']"));
				     ...
				     WebDriverUtils1.dropdown(wpen, 1);
