...
public class DataProviderContractor extends BaseClass1 {
	int pin1;
	...
	public void registrationForm(Object name, Object fname, Object add, Object city, Object pin, Object design,
		...
		driver.findElement(By.name("business_type")).sendKeys("GDWEDWQI@#$%^");
		...
		/*
		 * WebElement ele19=
		 * driver.findElement(By.xpath("//textarea[name@='nature_of_work']")) ;
		 * ele19.sendKeys("gfdghj"); // WebDriverUtils1.selectDataByjs(driver,
		 * ele19, detail);
		 */
		...
		WebDriverUtils1.dropdown(pid, 4);
