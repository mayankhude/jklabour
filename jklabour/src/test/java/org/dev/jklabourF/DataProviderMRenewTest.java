...
public class DataProviderMRenewTest extends BaseClass1{
			...
			Object no) throws EncryptedDocumentException, Throwable
	{
	 ...
	 /*---------------------------5.---------------------------------*/
	 	 ...
	 	 /*--------------------------- 6. ------------------------------*/    
	 	   ...
	 	   driver.findElement(By.name("business_type")).sendKeys("FRTSADYGSJH@#$%^&*HUFGKJ2345678");;
	  ...
	  /*---------------------------- 8. ------------------------------*/
           ...
           .sendKeys("FDGJGFGJtrfygdhsj;fyi!@#$%^&*(12345678"); ;
	 	...
	 	/*----------------------------- 10. --------------------------------*/
	 	    ...
	 	    WebElement ele27 =  driver.findElement(By.name("contractor_offence_detail"));
	 	    WebDriverUtils1.selectDataByjs(driver, ele27, no);
