...
public class BuildingWorkerFLengthTest extends BaseClass1
{ static int i=3;
  @Test
  ...
  public void BWorkerTest() throws EncryptedDocumentException, Throwable
  {
	  ...
	  String name="Lorem passages, and more recently with desktop"
			  ...
			  + "versions of Lorem Ipsum."+ " publishing software like Aldus PageMa" ;
...
driver.findElement(By.name("establishment_location"))
	.sendKeys(name);
	
	driver.findElement(By.name("establishment_postal_address_1"))
	.sendKeys(name);
	
	driver.findElement(By.name("establishment_postal_address_2"))
		.sendKeys(name);
		
	driver.findElement(By.name("establishment_postal_address_city"))
	.sendKeys(name);
	...
	driver.findElement(By.name("establishment_postal_address_pincode"))
	.sendKeys(name);

  /*--------------------------- 3. ----------------------------*/
	
	driver.findElement(By.name("establishment_permanent_address_1"))
		.sendKeys(name);
		
		driver.findElement(By.name("establishment_permanent_address_2"))
			.sendKeys(name);
			
		driver.findElement(By.name("establishment_permanent_address_city"))
		.sendKeys(name);
		...
		driver.findElement(By.name("establishment_permanent_address_pincode"))
		.sendKeys(name);
	...
	driver.findElement(By.name("establishment_manager_name"))
	.sendKeys(name);
	 
	driver.findElement(By.name("establishment_manager_address_1"))
			.sendKeys(name);
			
			driver.findElement(By.name("establishment_manager_address_2"))
				.sendKeys(name);
				
			driver.findElement(By.name("establishment_manager_address_city"))
			.sendKeys(name);
			...
			driver.findElement(By.name("establishment_manager_address_pincode"))
			.sendKeys(name);
 ...
 /*------------------------------ 6. --------------------------------*/			
			  ...
			  driver.findElement(By.name("max_no_of_workers"))
				.sendKeys(name);
