...
public class FLengthMigrantWorkerTest extends BaseClass1 {
...

	{
		...
		driver.findElement(By.xpath("//input[@name='est_post_address_2']")).sendKeys(name);
		...
		driver.findElement(By.name("pemp_name")).sendKeys(name);

		driver.findElement(By.name("pemp_fat_hus_name")).sendKeys(name);

		driver.findElement(By.xpath("//input[@name='pemp_address_1']")).sendKeys(name);

		driver.findElement(By.xpath("//input[@name='pemp_address_2']")).sendKeys(name);

		driver.findElement(By.xpath("//input[@name='pemp_address_city']")).sendKeys(name);

		WebElement pdist = driver.findElement(By.xpath("//select[@name='pemp_address_district_id']"));
		WebDriverUtils1.dropdown(pdist, 3);

		driver.findElement(By.name("pemp_address_pincode")).sendKeys(name);
