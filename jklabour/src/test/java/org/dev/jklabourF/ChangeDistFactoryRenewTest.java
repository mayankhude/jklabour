...
public class ChangeDistFactoryRenewTest extends BaseClass1 {
	static int i = 2;
	...
	{ FactoryAct1 fa=PageFactory.initElements(driver,FactoryAct1.class);
	   fa.factoryAct();
	    ...
	    System.out.println(fname);
	     ...
	     .sendKeys("erstdyugiojkj@#$%^&*&65435678");
	     
	   
	     
	  driver.findElement(By.xpath("//textarea[@name='detail_next_12_months']"))
	  .sendKeys("esrtdyghjk;ljkhg!@#$%^&*dfcghbnj");
...
/*---------------------------no of worker---------------------------*/
	...
	/*--------------1. name and residential address of the occupier---------*/      
	      ...
	      driver.findElement(By.xpath("//div[2]/table/tbody/tr[1]/td[1]/div/input"))
	      .sendKeys(rname);
	      
	      String radd=fl.getStringExcelData(2, 35);
	      driver.findElement(By.xpath("//div[2]/table/tbody/tr[1]/td[2]/div/input"))
	      .sendKeys(radd);;
 ...
 /*--------------2. name and residential address of the occupier---------*/
	      ...
	      driver.findElement(By.xpath("//div[2]/table/tbody/tr[2]/td[1]/div/input"))
	      .sendKeys(rname2);
	      
	      String radd2=fl.getStringExcelData(2, 35);
	      driver.findElement(By.xpath("//div[2]/table/tbody/tr[2]/td[2]/div/input"))
	      .sendKeys(radd2);;
	    ...
	    WebElement we=  driver.findElement(By.xpath("//select[@name='consent_certificate_id']"));
	      ...
	      /*----------------19.  --------------------------*/
			    ...
			    WebElement wmgr=  driver.findElement(By.xpath("//select[@name='manager_letter_id']"));
			      ...
			      WebDriverUtils1.dropdown(wmgr, 5);
	      ...
	      /*----------------22.  --------------------------*/
		    ...
		    WebElement wpass=  driver.findElement(By.xpath("//select[@name='passport_doc_id']"));
		      ...
		      WebDriverUtils1.dropdown(wpass, 7);
	      ...
	      /*----------------23.  --------------------------*/
			    ...
			    WebElement wsupport=  driver.findElement(By.xpath("//select[@name='support_doc1_id']"));
			      ...
			      WebDriverUtils1.dropdown(wsupport, 6);
	     ...
	     WebDriverUtils1.dropdown(wpen,7);
