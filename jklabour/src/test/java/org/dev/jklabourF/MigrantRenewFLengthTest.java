...
public class MigrantRenewFLengthTest extends BaseClass1{
	
	static int i=3;
	
	@Test
	
	public void MigrantRenewTest() throws EncryptedDocumentException, Throwable
	{
		    ...
		    driver.findElement(By.xpath("//button[@type='submit']")).click();	
		     ...
		     driver.findElement(By.id("btn-online-reg")).click();
			    ...
			    String name="Lorem passages, and more recently with desktop"
			    		...
			    		+ "versions of Lorem Ipsum."+ " publishing software lisum.";
