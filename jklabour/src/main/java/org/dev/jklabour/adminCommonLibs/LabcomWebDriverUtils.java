...
import org.openqa.selenium.support.ui.WebDriverWait;
 ...
 public class LabcomWebDriverUtils {
 ...
 /*---------------------------------maximize window------------------*/ 
	 ...
	 {
		 labcom.driver.manage().window().maximize();
	 }
 ...
 /*---------------------implicitly wait method ---------------------*/
	 ...
	 public void implicitlyWait( int time)
	    {
		labcom.driver.manage().timeouts().implicitlyWait(time, TimeUnit.SECONDS);
	    }
  ...
  /*--------------------------explicitly wait method-----------------------------*/
	 ...
	 public  void explicitlyWait(long time,  String xpath )
	    ...
	    {
		  WebDriverWait wait=new WebDriverWait(labcom.driver, time);
		  wait.until
  ...
  /*----------------------create action class to select -----------------------*/
      public static void selectDropdownMenu(WebElement we)
         {
    	   Actions act=new Actions(labcom.driver);
      ...
      /*-----------------------new Tab Handeling method--------------------*/
         ...
         public static void newTab(){
   		Set<String> set=labcom.driver.getWindowHandles();
   		...
   		labcom.driver.switchTo().window(childId);
