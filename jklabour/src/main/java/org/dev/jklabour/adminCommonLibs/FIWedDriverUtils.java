...
/*---------------------------------maximize window------------------*/ 
	 ...
	 {
		 AdminBaseClassIOF.driver.manage().window().maximize();
	 }
...
/*---------------------implicitly wait method ---------------------*/
	 ...
	 public void implicitlyWait( int time)
	    {
		 AdminBaseClassIOF.driver.manage().timeouts().implicitlyWait(time, TimeUnit.SECONDS);
	    }
 ...
 /*--------------------------explicitly wait method-----------------------------*/
	 ...
	 public  void explicitlyWait(long time,  String xpath )
	    ...
	    {
		  WebDriverWait wait=new WebDriverWait(AdminBaseClassIOF.driver, time);
		  wait.until
 ...
 /*----------------------create action class to select -----------------------*/
     public static void selectDropdownMenu(WebElement we)
        {
   	   Actions act=new Actions(AdminBaseClassIOF.driver);
     ...
     /*-----------------------new Tab Handeling method--------------------*/
        ...
        public static void newTab(){
  		Set<String> set=AdminBaseClassIOF.driver.getWindowHandles();
  		...
  		AdminBaseClassIOF.driver.switchTo().window(childId);
