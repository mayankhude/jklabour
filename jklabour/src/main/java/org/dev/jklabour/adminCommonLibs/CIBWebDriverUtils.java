...
import org.openqa.selenium.support.ui.WebDriverWait;
 ...
 public class CIBWebDriverUtils {
 ...
 /*---------------------------------maximize window------------------*/ 
	 ...
	 {
		AdminBaseClassCIB.driver.manage().window().maximize();
	 }
 ...
 /*---------------------implicitly wait method ---------------------*/
	 ...
	 public void implicitlyWait( int time)
	    {
		AdminBaseClassCIB.driver.manage().timeouts().implicitlyWait(time, TimeUnit.SECONDS);
	    }
  ...
  /*--------------------------explicitly wait method-----------------------------*/
	 ...
	 public  void explicitlyWait(long time,  String xpath )
	    ...
	    {
		  WebDriverWait wait=new WebDriverWait(AdminBaseClassCIB.driver, time);
		  wait.until
  ...
  /*----------------------create action class to select -----------------------*/
      public static void selectDropdownMenu(WebElement we)
         {
    	   Actions act=new Actions(AdminBaseClassCIB.driver);
      ...
      /*-----------------------new Tab Handeling method--------------------*/
         ...
         public static void newTab(){
   		Set<String> set=AdminBaseClassCIB.driver.getWindowHandles();
   		...
   		AdminBaseClassCIB.driver.switchTo().window(childId);
