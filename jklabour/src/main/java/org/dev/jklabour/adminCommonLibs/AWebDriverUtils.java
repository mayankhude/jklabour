...
import org.openqa.selenium.support.ui.WebDriverWait;
 ...
 /*---------------------------------maximize window------------------*/ 
	 ...
	 {
		 AdminBaseClassALC.driver.manage().window().maximize();
	 }
 ...
 /*---------------------implicitly wait method ---------------------*/
	 ...
	 public void implicitlyWait( int time)
	    {
		 AdminBaseClassALC.driver.manage().timeouts().implicitlyWait(time, TimeUnit.SECONDS);
	    }
  ...
  /*--------------------------explicitly wait method-----------------------------*/
	 ...
	 public  void explicitlyWait(long time,  String xpath )
	    ...
	    {
		  WebDriverWait wait=new WebDriverWait(AdminBaseClassALC.driver, time);
		  wait.until
  ...
  /*----------------------create action class to select -----------------------*/
      public static void selectDropdownMenu(WebElement we)
         {
    	   Actions act=new Actions(AdminBaseClassALC.driver);
   ...
   /*-----------------------new Tab Handeling method--------------------*/
      ...
      public  static void newTab(){
		Set<String> set=AdminBaseClassALC.driver.getWindowHandles();
		...
		AdminBaseClassALC.driver.switchTo().window(childId);
